...
import edu.utep.joaquin.parstagram.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    //Needed?
    //Setup the layout file for this fragment
    @Override
...
//        queryPosts();
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(description.isEmpty() ){
                    Toast.makeText(getContext(), "desciption cannt be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public File getPhotoFileUri(String fileName) {
        ...
        File mediaStorageDir = new File(getContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES), "abc123");
